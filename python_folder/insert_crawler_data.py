    ...
    for product in data:
        ...
        for color in colors_list:
            for _ in color:
                ...
                my_cursor.execute(query_insert_colors,(_['name'],_['code']))
                ...
                if my_cursor.rowcount > 0:
                    ...
                    my_cursor.execute(query_select_color_id, (_['name']))
        ...
        for size in sizes_list:
            for _ in size:
                my_cursor.execute(query_insert_variants,(last_product_id,last_color_id, _, 10))
                db.commit()
