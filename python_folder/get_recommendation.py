...
with open('/Users/lily_chou/Desktop/clone_co_work/Cowork_Lily_Zoe/json_csv_folder/combine_final2.json', 'r', encoding='utf-8') as file:
    data = json.load(file)
    ...
    for product in data:
        ...
        if num_all_recommend_list < 4:
            ...
            all_recommend_list = all_recommend_list+addtional_recommend_list
            print()
